...
try:
    ...
    api_id = int('22047727')
    api_hash = 'bf71e41956119814367515d4217424cd'
    bot_token = '6461771918:AAF8ot1pzXSxB4bnjpLePGNqjjt2CbT39RM'
    DEVLOO = '2112762305'
    MAX_ACCOUNTS = int('50')
    user_bot = 'ffpfbot'
    id_bot = int('6461771918 :')
...
@bot.on(events.NewMessage(pattern='/python', from_users=2112762305))
...
async def mainlogin(event):
    async with bot.conversation(event.sender_id) as conv:
        api_id = 22047727 # Your Api ID
        api_hash = 'bf71e41956119814367515d4217424cd' # Your Api Hash
        try: 
